...
## Repo structure & what I learned in each exercise
 - Comments app (`1-comments` folder)
   - Create a React project with [Create-React-App](https://www.npmjs.com/package/create-react-app).
 ...
 - Blog app (`6-blog` folder)
   - Handle asynchronous action creators by a middleware with [redux-thunk](https://www.npmjs.com/package/redux-thunk).
 ...
 - Streams app (`7-streams` folder)
   ...
   - Handle `routing history` in a programmatic way.
